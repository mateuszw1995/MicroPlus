		...
		namespace gui {
			class text_interface {
				...
				struct action {
					...
					action(text_interface* subject, int where, const formatted_char&);
					action(text_interface* subject, int where, const formatted_char&, const fstr& replaced);
					action(text_interface* subject, int where, const fstr&, type flag = INSERT);
					action(text_interface* subject, int where, const fstr&, const fstr& replaced = fstr());
					action(text_interface* subject, int left, int right, bool unapply, vector<bool>&, type flag);
